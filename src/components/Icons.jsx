...
// 1. cube-16-solid.svg (Navbar logo, Hero icon, Footer logo)
export const SolidCubeIcon = ({ className = "w-4 h-4", ...props }) => (
  <svg 
...
// 2. arrow-trending-up.svg (Stats section, Bento card)
export const ArrowTrendingUpIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="none"
    ...
    className={className} 
    role="img" 
    aria-label="Arrow trending up icon" 
    {...props}
  >
...
// 3. chart-pie.svg (Bento card — Analytics)
export const ChartPieIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="none"
...
// 4. cog-8-tooth.svg (Bento card — Automation)
...
// 5. arrow-path.svg (Bento card — Sync/Refresh)
export const ArrowPathIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="none"
...
// 7. link-solid.svg (Bento card — Integrations)
export const SolidLinkIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="currentColor" 
...
// 9. chevron-down.svg (Currency dropdown trigger)
...
// 10. chevron-up.svg (Accordion close state)
...
// 11. chevron-up-solid.svg (Accordion active close)
export const SolidChevronUpIcon = ({ className = "w-4 h-4", ...props }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="currentColor" 
    className={className} 
    role="img" 
    aria-label="Chevron up solid icon" 
    {...props}
  >
...
// 12. chevron-left.svg (Mobile carousel or scroll hint)
...
// 13. chevron-right.svg (Mobile carousel or CTA arrow)
...
// 14. x-mark.svg (Mobile menu close, modal close)
